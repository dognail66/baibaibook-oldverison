  ...
  <section class="bbs-page">
    ...
    <div class="bbs-sections">
      ...
      <Collapsible title="摘要设置" :open="false">
        ...
        <p class="bbs-field-hint">开启后自动摘要并隐藏旧楼，同时启用正文时间标签（剧情时间锚点）。</p>
        <label class="bbs-switch-row">
          <span class="bbs-field-label">允许上一楼未摘要时继续生成</span>
          <input v-model="apiSettings.allowGenerationWithPendingSummary" type="checkbox" class="bbs-checkbox" />
        </label>
        <p class="bbs-field-hint">默认允许继续生成。关闭后，发现前面有漏摘楼层时会拦截本次生成并提示先补摘。</p>
        <label class="bbs-switch-row">
          <span class="bbs-field-label">后台静默补摘</span>
          <input v-model="apiSettings.silentBackfill" type="checkbox" class="bbs-checkbox" />
        </label>
        <p class="bbs-field-hint">勾选后不显示自动补摘的等待横幅，只隐藏通知，不影响副 API 分析、摘要生成和写入。</p>
        <label class="bbs-switch-row">
        ...
        <div class="bbs-feature-switches">
          <p class="bbs-field-label">单项功能关闭</p>
          <p class="bbs-field-hint">勾选后停止该功能的副 API 分析、主模型与向量查询注入，并隐藏对应面板入口；已有数据不会删除，取消勾选即可恢复。剧情摘要正文仍正常生成。</p>
          <label class="bbs-switch-row">
            <span class="bbs-field-label">关闭计划</span>
            <input v-model="apiSettings.disabledFeatures.plans" type="checkbox" class="bbs-checkbox" />
          </label>
          <label class="bbs-switch-row">
            <span class="bbs-field-label">关闭悬念</span>
            <input v-model="apiSettings.disabledFeatures.suspenses" type="checkbox" class="bbs-checkbox" />
          </label>
          <label class="bbs-switch-row">
            <span class="bbs-field-label">关闭物品</span>
            <input v-model="apiSettings.disabledFeatures.items" type="checkbox" class="bbs-checkbox" />
          </label>
          <label class="bbs-switch-row">
            <span class="bbs-field-label">关闭场景</span>
            <input v-model="apiSettings.disabledFeatures.scenes" type="checkbox" class="bbs-checkbox" />
          </label>
        </div>
...
.bbs-feature-switches > .bbs-field-hint {
  margin-top: 4px;
}
